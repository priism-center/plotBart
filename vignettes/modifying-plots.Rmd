...
plotBart uses ggplot2 to construct plots. These functions return ggplot objects that can be manipulated and adjusted similar to standard `ggplot2::ggplot()` calls. Plot titles, subtitles, labels, captions, and themes can be easily adjusted using ggplot syntax.
